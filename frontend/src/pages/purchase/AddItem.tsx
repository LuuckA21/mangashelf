...
/** Searchable, paginated form for adding a volume to the list. */
export default function AddItem({
  ...
  const loadManga = useCallback(
    async (query = '', targetPage = 0, append = false) => {
          ...
          <div className="row" style={{ marginTop: 8 }}>
            ...
            {mangaPage + 1 < mangaTotalPages && (
              <button
                ...
                disabled={mangaLoading}
                onClick={() =>
                  void loadManga(activeMangaQuery, mangaPage + 1, true)
                }
              >
